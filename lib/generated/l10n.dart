...
class S {
  ...
  String get search_for_challan_user {
    return Intl.message(
      'Search for vehicle owner',
      name: 'search_for_challan_user',
      desc: '',
      args: [],
    );
  }
  ...
  String get Select_vehicle_images {
    return Intl.message(
      'Select vehicle images',
      name: 'Select_vehicle_images',
      desc: '',
      args: [],
    );
  }

  String get select_impounding_document {
    return Intl.message(
      'Select Impounding document',
      name: 'select_impounding_document',
      desc: '',
      args: [],
    );
  }
  ...
  String get Search_for_the_owner {
    return Intl.message(
      'Search for the owner',
      name: 'Search_for_the_owner',
      desc: '',
      args: [],
    );
  }
  ...
  String get Compounding_fees {
    return Intl.message(
      'Compounding fees',
      name: 'Compounding_fees',
      desc: '',
      args: [],
    );
  }
  ...
  String get should_be_more_than_4_characters {
    return Intl.message(
      'Should be more than 4 characters',
      name: 'should_be_more_than_4_characters',
      desc: '',
      args: [],
    );
  }
  ...
  String get should_be_more_than_10_characters {
    return Intl.message(
      'Should be more than 10 characters',
      name: 'should_be_more_than_10_characters',
      desc: '',
      args: [],
    );
  }

  String get should_be_more_than_12_characters {
    return Intl.message(
      'Should be more than 12 characters',
      name: 'should_be_more_than_12_characters',
      desc: '',
      args: [],
    );
  }
